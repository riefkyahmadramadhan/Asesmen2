...
import org.d3if0142.myquotes.database.BukuDb
import org.d3if0142.myquotes.ui.theme.MyQuotesTheme
import org.d3if0142.myquotes.util.ViewModelFactory
...
@Composable
fun FormBuku(
    judul: String, onNameChange: (String) -> Unit,
    quotes: String, onNimChange: (String) -> Unit,
    genre: String, onKelasChange: (String) -> Unit,
    modifier: Modifier
) {
    val radioOptions = listOf(
        stringResource(id = R.string.kelas01),
        stringResource(id = R.string.kelas02),
        stringResource(id = R.string.kelas03),
        stringResource(id = R.string.kelas04),
        stringResource(id = R.string.kelas05)
    )
