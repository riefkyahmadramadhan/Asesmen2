package org.d3ifd3if0142.myquotes.ui.screen
...
@Composable
fun GridItem(catatan: Buku, onClick: () -> Unit){
    Card (
        modifier = Modifier
            .fillMaxWidth()
            .clickable { onClick() },
